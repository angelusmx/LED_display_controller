...
def calculate_performance():
    ...
    threading.Timer(3.0, calculate_performance).start()
    random_decimal = random.randrange(0, 101, 2)   # Even integer from 0 to 100
...
config_transmission = config_prefix + config_crc_prefix + config_crc_string + string_suffix
